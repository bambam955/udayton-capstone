...
Runtime data is generated by a shared build script:

- Build script: `mocks/src/build.js`
- Output files (gitignored):
  - `mocks/dist/walmart.mockoon.json`
  - `mocks/dist/target.mockoon.json`
...
Automated smoke tests are available in Jest and cover these same endpoint checks.
