...
const driverRecords: DriverRecord[] = [
  ...
  },
  {
    id: "D-002",
    name: "Leo Turner",
    serviceZone: "Eastgate",
    activePickup: "Walmart - Eastgate",
    availability: "On delivery",
    verificationStatus: "Verified",
  },
  {
  ...
  },
  {
    id: "D-004",
    name: "Nora Singh",
    serviceZone: "South Bay",
    activePickup: "Target - South Bay",
    availability: "On delivery",
    verificationStatus: "Verified",
  },
  {
...
const availableNow = driverRecords.filter(
  (driver) => driver.availability === "Available",
).length;
const onDelivery = driverRecords.filter(
  (driver) => driver.availability === "On delivery",
).length;
