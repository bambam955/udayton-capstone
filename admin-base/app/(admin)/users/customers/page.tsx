...
const customerRecords: CustomerRecord[] = [
  ...
  },
  {
    ...
    ownerName: "Avery Kim",
    primaryStore: "Target - Harbor",
    openOrders: 1,
    status: "Needs follow-up",
  },
  {
    id: "C-004",
    businessName: "Bayside Bakery",
    ownerName: "Morgan Park",
    primaryStore: "Walmart - South Bay",
    openOrders: 2,
    status: "Active",
  },
  {
    id: "C-005",
    businessName: "Central Auto Care",
    ownerName: "Casey Noor",
    primaryStore: "Target - Central",
    openOrders: 0,
    status: "Active",
  },
  {
    id: "C-006",
    businessName: "Oakline Flowers",
    ownerName: "Drew Patel",
    primaryStore: "Target - West End",
    openOrders: 2,
    status: "Active",
  },
  {
    id: "C-007",
    businessName: "Metro Hardware",
    ownerName: "Reese Flynn",
    primaryStore: "Walmart - Metro",
    openOrders: 4,
    status: "Needs follow-up",
  },
  {
    id: "C-008",
    businessName: "Summit Pet Supply",
    ownerName: "Quinn Scott",
    primaryStore: "Target - Summit",
    openOrders: 1,
    status: "Active",
  },
  {
    id: "C-009",
    businessName: "Riverbend Office Co.",
    ownerName: "Sky Rivera",
    primaryStore: "Walmart - Riverbend",
    openOrders: 2,
    status: "Active",
  },
  {
    id: "C-010",
    businessName: "Westfield Market",
    ownerName: "Riley Chen",
    primaryStore: "Target - Westfield",
    openOrders: 3,
    status: "Active",
  },
  {
    id: "C-011",
    businessName: "Greenline Gym",
    ownerName: "Nico Hall",
    primaryStore: "Walmart - Greenline",
    openOrders: 1,
    status: "Active",
  },
  {
    id: "C-012",
    businessName: "Beacon Bookstore",
    ownerName: "Jamie Ross",
    primaryStore: "Target - Beacon",
    openOrders: 0,
    status: "Active",
  },
];
...
const activeOrders = customerRecords.filter(
  (customer) => customer.openOrders > 0,
).length;
const needsFollowUp = customerRecords.filter(
  (customer) => customer.status === "Needs follow-up",
).length;
